...
<table style="border-collapse: collapse; width: 100%; background:#fff;">
  <thead>
    <tr style="background:#000;">
      <th style="background:#000; color:#fff; padding:8px; border:1px solid #444;">Image 1</th>
      <th style="background:#000; color:#fff; padding:8px; border:1px solid #444;">Image 2</th>
      <th style="background:#000; color:#fff; padding:8px; border:1px solid #444;">Image 3</th>
      <th style="background:#000; color:#fff; padding:8px; border:1px solid #444;">Image 4</th>
    </tr>
  </thead>

  <tbody style="background:#fff;">
    <tr style="background:#fff;">
      <td style="background:#fff; padding:12px; border:1px solid #ccc; text-align:center;">
